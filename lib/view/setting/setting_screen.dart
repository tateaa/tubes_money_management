import 'package:tubes_money_management/view/setting/terms.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        systemOverlayStyle: SystemUiOverlayStyle(
          statusBarColor: Colors.purple, // Warna latar belakang status bar
          statusBarBrightness: Brightness.dark, // Warna teks status bar
        ),
        title: Text(
          'Setting',
          style: TextStyle(
